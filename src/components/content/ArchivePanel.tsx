...
export default component$<ArchivePanelProps>(({ sortedPosts = [] }) => {
	// Parse URL parameters
	const getUrlParams = () => {
		if (typeof window === "undefined")
			return { tags: [], categories: [], uncategorized: null };
	...
	const urlParams = useSignal(getUrlParams());
	...
	// Computed groups using useComputed$
	const groups = useComputed$(() => {
		let filteredPosts: PostForList[] = sortedPosts;
		const { tags, categories, uncategorized } = urlParams.value;
