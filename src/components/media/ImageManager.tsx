...
export default component$(() => {
	...
	// biome-ignore lint/correctness/noQwikUseVisibleTask: Required for PhotoSwipe initialization and DOM manipulation
	useVisibleTask$(() => {
					...
					mutation.addedNodes.forEach((node) => {
						if (node.nodeType === 1) {
							...
							if (el.hasAttribute("data-image-wrapper")) {
								...
								el.querySelectorAll?.("[data-image-wrapper]").forEach(
									(child) => {
										wrappers.add(child);
									},
								);
