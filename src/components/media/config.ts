...
/**
 * Default PhotoSwipe configuration
 * Extracted as constant for better performance (no recreation on each render)
 */
export const DEFAULT_PHOTOSWIPE_CONFIG: PhotoSwipeConfig = {
...
export const DEFAULT_IMAGE_SELECTOR = "[data-image-wrapper]";
