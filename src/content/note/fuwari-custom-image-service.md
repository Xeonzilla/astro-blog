...
timestamp: 2025-11-16 01:21:00+08:00
series: 站点建设
tags: [Astro]
toc: true
---

![](https://blog-static.xeonzilla.top/img/fuwari-custom-image-service/cover.avif)
...
为了更好地理解本文的背景和探索过程，我建议先阅读姊妹篇[为 Fuwari 启用响应式图像](/note/fuwari-responsive-images)，以了解我在进行本次修改前所做的修改。同样地，本文侧重于过程记录而非详尽的教程，因此文中可能存在不严谨之处或信息缺漏。
