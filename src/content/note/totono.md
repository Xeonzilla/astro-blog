...
![](https://blog-static.xeonzilla.top/img/totono/cover.avif)
...
长时间的重复流程则是另一层面的强制，玩家随时可以退出游戏，这是为数不多可以实现的选择，但是只要你选择继续游戏，就必须听从游戏的指挥，慢慢地提升或是降低美雪的好感度。游戏不允许你进行过多的跳过，因为玩家与美雪度过的每一天都有新的选项供你抉择。当然，无论你如何抉择，都会莫名其妙的的睡去，然后在新的一天醒来。不断重复的日常中，一些对话的细微变化，算是为数不多的乐趣了。
