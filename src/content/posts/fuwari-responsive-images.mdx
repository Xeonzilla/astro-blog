...
```astro title="src/components/misc/ImageWrapper.astro" startLineNumber=50 "inferSize={true}"
...
```astro title="src/components/MarkdownImage.astro"
---
import { Image } from "astro:assets";
...
```astro title="src/components/misc/ImageWrapper.astro" collapse={1-3,15-18,30-60} ins={11-13,25-27} "widths={widths} quality={quality} sizes={sizes}"
---
...
```astro title="src/components/widget/Profile.astro" collapse={22-39} ins={3} {20}
---
...
```astro title="src/pages/posts/[...slug].astro" startLineNumber=108 "components={{ MarkdownImage: MarkdownImage }}"
