...
继前面[部署 Umami](/posts/netlify_supabase_umami/)和[数据库迁移](/posts/from_supabase_to_neon/)后，我又在使用 Umami 的过程中发现了新问题：怎么仪表盘的数据全是重复的呢？在 GitHub 一番搜索后，我找到了三个相同的案例[^1][^2][^3]，而且非常遗憾，开发者没有任何有效的答复，这个 Bug 目前悬而未决。
