...
image: "https://blog-static.xeonzilla.top/img/from-supabase-to-neon/cover.avif"
tags:
  - "技术"
  - "云服务"
---
...
就在我写完[上篇文章](/posts/netlify-supabase-umami/)没多久，在论坛查找资料的途中，我偶然发现了 Supabase 的新兴竞品，Neon[^1]。一番对比后，我决定火速将 Waline 和 Umami 的数据库迁移到 Neon。
